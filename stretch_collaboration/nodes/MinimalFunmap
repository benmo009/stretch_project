...
class FunmapNode(hm.HelloNode):
    ...
    def main(self):
        ...
        ###############################################
        # Initialize subscribers and publishers needed
        ###############################################

        # Camera services, default and high accuracy
        ...
        # Upload map to parameter server


        # Wait for merged map parameter

        # Set map to merged parameter

        # publish map point cloud and odom transform
